...
function EducationDetails({ navigation }) {
    ...
    async function getData() {
        try {
            ...
            const allKeysArr = keysArr.filter(entry => entry.startsWith("educationdetail"));
            ...
            {loader ? (
                ...
                <View style={{ flex: 1, marginTop: 22 }}>
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity onPress={() => navigation.navigate('EachLevelDetail', { data: item[0] })}>
