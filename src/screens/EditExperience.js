...
function EditExperience({ route, navigation }) {
    ...
    async function updateExperience(companyName, role, skillsUsed, startingDate, leavingDate, ctc) {
        let recieved_data = { image, companyName, role, skillsUsed, startingDate, leavingDate, ctc }
        if (image) {
            ...
            <View style={{ flex: 1 }}>
                {loader ? (
                    ...
                    <Formik
                        ...
                        onSubmit={(values) => (
                            updateExperience(companyName = values.companyName, role = values.role, skillsUsed = values.skillsUsed, startingDate = values.startingDate, leavingDate = values.leavingDate, ctc = values.ctc)
                        )}
                    >
                        {({
                            values,
