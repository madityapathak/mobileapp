...
function EditProfile({ route, navigation }) {
    ...
    async function updateUserDetails(userName, userEmail, userAddress, birthDate, phoneNumber, projects, pL, frameWorks) {
        let recieved_data = { image, userName, userEmail, userAddress, birthDate, phoneNumber, projects, pL, frameWorks }
        if (image) {
    ...
    return (
        <SafeAreaView style={styles.outerMostView}>
            ...
            <View style={styles.titleBar}>
                ...
                <Text style={styles.headingText}>Update User Details</Text>
            </View>
            ...
            <View style={{ flex: 1 }}>
                {loader ? (
                    ...
                    <Formik
                        ...
                        onSubmit={(values) => (
                            updateUserDetails(userName = values.userName, userEmail = values.userEmail, userAddress = values.userAddress, birthDate = values.birthDate, phoneNumber = values.phoneNumber, projects = values.projects, pL = values.pL, frameWorks = values.frameWorks)
                        )}
                    >
                        {({
                            values,
